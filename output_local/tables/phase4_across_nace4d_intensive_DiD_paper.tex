...
\midrule
\makecell[l]{2005 event \\ \footnotesize{(ETS-treated vs non-ETS)}} & \makecell{-0.0082$^{***}$ \\ \footnotesize{(0.0021)} \\ \footnotesize{N=447k}} \\\addlinespace
\makecell[l]{2017 event \\ \footnotesize{(high-$\omega$ vs low-$\omega$, within ETS)}} & \makecell{-0.0033 \\ \footnotesize{(0.0037)} \\ \footnotesize{N=63k}} \\\addlinespace
\makecell[l]{2017 event \\ \footnotesize{(top-quartile $\omega$ vs non-ETS)}} & \makecell{-0.0023 \\ \footnotesize{(0.0051)} \\ \footnotesize{N=168k}} \\\addlinespace
\bottomrule
\end{tabular}
